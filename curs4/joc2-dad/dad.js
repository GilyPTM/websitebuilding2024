  ...
  if (slotNumber === cardNumber) {
    ...
    if (slotNumber == 1) {
      $("#message")
        .show()
        .html(
          ' PHP cel mai tare limbaj de programare. A fost desemnat limbajul anului 2004. <br> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/PHP-logo.svg/300px-PHP-logo.svg.png" style="max-width:150px">'
        );
    }
  }
